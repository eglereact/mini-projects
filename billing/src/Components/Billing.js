    ...
    <div className="bg-white rounded-3xl w-full ">
      <div className="mx-10">
        ...
        <div className="flex items-center space-x-10 ">
          <div className="bg-gray-100 shadow-md rounded-lg flex h-36 items-center w-2/6 justify-center">
            <div className="px-3">
          ...
          <div className="bg-gray-100 shadow-md rounded-lg px-3 h-36 w-4/6 mx-2">
            ...
            <div>
              <div className="bg-blue-100 rounded-lg p-2 text-gray-800">
                <p className="text-sm ">
                  Quickpay let's you receive payments on the fly. You can
                  generate invoice or share the payment link.
                </p>
