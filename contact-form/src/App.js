  ...
  return (
    <main className="flex flex-col sm:flex-row justify-center items-center min-h-screen lg:w-2/3  mx-auto">
      ...
      <div className="flex items-center justify-center mx-10 sm:mr-10">
        ...
        <div className="bg-white h-[500px] flex flex-col rounded-lg w-full py-6 px-10">
          ...
          <div className="flex items-center mb-6">
            ...
            <label for="email" className="mr-4 ml-1 text-lg text-gray-800">
              Email
            </label>
            <input type="radio" id="phone" name="drone" value="phone" />
            <label for="phone" className="mr-4 ml-1 text-lg text-gray-800">
              Phone
            </label>
          </div>
          <p className="text-lg text-gray-800">Message</p>
          <textarea className="outline-none border-b w-full border-gray-300 mb-4" />
          {/* <button className="bg-[#FB44D2] text-white w-full rounded-full py-4 mt-6">
            Submit
          </button> */}
          <button class="relative  inline-flex items-center justify-center p-4 px-5 py-5 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out rounded-full shadow-xl group hover:ring-1 hover:ring-purple-500">
